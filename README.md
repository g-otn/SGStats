...
- Smithtaiment server info through [Smithtainment Status API](https://status.smithtainment.com/)
...
```json
{
    "anime": {
        "name": "Anime PropHunt",
        "ip": "209.126.103.165:27045",
        "gamertrackerID": "6035198",
        "smithtainmentStatusAPIName": "aph"
    }
}
```
- **Object key** (Ex: ``anime``): The single word abbreviation for the server, used in commands
...
- **``smithtainmentStatusAPIName``**: Optional. A part of the server specific URL path in a Smithtainment Status API page. Only available on Smithtainment Gaming servers.
